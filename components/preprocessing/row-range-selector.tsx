...
export function RowRangeSelector({
    ...
    const selectedRowCount = isEnabled
    ...
    if (totalRows === 0) {
        return (
            ...
            >
                ...
                <p className="mt-1 text-xs">Load a file to select rows</p>
            </div>
        );
    }
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "text-muted-foreground flex items-center justify-between px-1 text-xs transition-opacity",
            ...
            >
                <span>
                    {isEnabled ? (
                        <>
                            Rows {formatNumber(startValue)} to{" "}
                ...
                <span className="tabular-nums">
                    {formatNumber(selectedRowCount)} of{" "}
            ...
            <div
                className={cn(
                    "bg-secondary h-2 w-full overflow-hidden rounded-full transition-opacity",
                    !isEnabled && "opacity-50",
                )}
            >
                {isEnabled ? (
