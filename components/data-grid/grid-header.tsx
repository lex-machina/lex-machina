...
const GridHeader = ({
    ...
    return (
        <div
            className="bg-muted sticky top-0 z-10 shrink-0 border-b"
            ...
            <div className="flex h-full">
                {columns.map((col, index) => {
                    ...
                    return (
                        <div
                            key={col.name}
                            className="text-muted-foreground relative flex shrink-0 items-center overflow-hidden border-r px-2 text-sm font-semibold"
                        ...
                        >
                            ...
                            <div
                                className={cn(
                                    "absolute top-0 right-0 bottom-0 w-1 cursor-col-resize transition-colors",
                                    "hover:bg-primary/50",
