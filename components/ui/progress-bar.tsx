...
export function ProgressBar({
  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className)} data-slot="progress">
      {(label || showLabel) && (
...
export function StageProgress({
  ...
  return (
    <div className={cn("flex flex-col gap-3", className)} data-slot="stage-progress">
      {/* Overall progress */}
      <ProgressBar
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <ProgressBar value={stageProgress * 100} size="sm" variant="default" />
      </div>
