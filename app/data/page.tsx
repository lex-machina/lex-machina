                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <dd className="font-medium">
                                <span className="text-green-500">
                                    {(
                                        summary.data_quality_score_after * 100
                                    ).toFixed(0)}
                                    %
                                </span>
                                ...
                                <span className="text-amber-500">
                                    {(
                                        summary.data_quality_score_before * 100
                                    ).toFixed(0)}
                                    %
                                </span>
                            </dd>
...
function DataPageContent() {
    ...
    const { hasProcessedData, refresh: refreshProcessedData } =
        useProcessedData();
    ...
    const activeTab: DataTab =
        tabParam === "processed" && hasProcessedData ? "processed" : "original";
    ...
    return (
        ...
        >
            {/* Tab Content */}
            {activeTab === "original" ? <DataGrid /> : <ProcessedDataGrid />}
        </AppShell>
    );
}
